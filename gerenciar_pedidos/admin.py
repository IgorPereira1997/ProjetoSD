...
class PedidosAdmin(admin.ModelAdmin):
    list_display = ('pedidoid', 'cliente_tag', 'transportadora_tag','data_pedido', 'data_saida', 'data_entrega', 'status_tag', 'valor', 'conhecimento')
    exclude=('created_at',)
...
class PedidosItemAdmin(admin.ModelAdmin):
    list_display = ('pedidoid', 'image_tag','produto_tag', 'quantidade_str', 'precounitario_tag')
    exclude=('created_at',)
